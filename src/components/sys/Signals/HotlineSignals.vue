    ...
    <div>
        ...
        <div class="card-body px-5 py-5 bg-light shadow-lg table-responsive">
            <form method="POST" id="AddSignalCategory" enctype="multipart/form-data">
                ...
                <input type="text" name="EbsType" value="HOTLINE" class="d-none" />
...
export default {
    ...
    mounted() {
        ...
        window.SetMyPageTitle("Create and Manage HOTLINE EBS signals");
