                ...
                <div class="d-flex flex-column flex-lg-row-fluid w-lg-100 p-10 order-2 order-lg-1">
                    ...
                    <div class="d-flex flex-center flex-column flex-lg-row-fluid">
                        ...
                        <div class="w-lg-500px p-10">
                            ...
                            <div class="w-lg-500px p-10">
                                <!--begin::Form-->
                                <form class="form-container form w-100" id="kt_sign_in_form" @submit.prevent="handleSubmit">
                                    <!--begin::Heading-->
                                    ...
                                    <div class="fv-row mb-8">
                                        ...
                                        <input type="text" placeholder="Phone Number" v-model="PhoneNumber"
                                            class="form-control bg-transparent" autocomplete />
                                        <!--end::Email-->
                                    </div>
                                    <!--end::Input group=-->
                                    ...
                                    <div class="d-grid mb-10">
                                        <button type="submit" id="kt_sign_in_submit" class="btn btn-primary  shadow-lg">
    ...
    methods: {
        ...
        handleSubmit() {
            if (!this.PhoneNumber || !this.password) {
                ...
                axios.post(window.SERVER_URL + 'AuthenticateUser', {
