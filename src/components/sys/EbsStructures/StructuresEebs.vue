    ...
    <div>
        <div class="card-body mb-3 pb-3 pe-2 bg-light shadow-lg table-responsive">
            <button type="button" data-bs-toggle="modal" data-bs-target="#ViewData"
                ...
                <i class="fas fa-eye"></i> View EEBS Structures
            </button>
        </div>
        <div class="card-body px-5 py-5 bg-light shadow-lg table-responsive">
            <form method="POST" id="AddHF">
                ...
                <input type="text" value="EEBS" name="EbsType" class=" d-none" />
                    ...
                    <div class="modal-header shadow-lg">
                        <div class="col-12">
                            <input type="text" class="form-control float-end mt-4" v-model="searchTerm"
                                placeholder="Search EEBS Structures" />
                        </div>
                    </div>
...
import SelectEebsFacilities from './SelectEebsFacilities.vue';
...
export default {
    ...
    mounted() {
        ...
        window.SetMyPageTitle("Manage EEBS Workflow Structure");
    ...
    methods: {
        ...
        async fetchAndDisplayData() {
            try {
                const {
                    data: { records },
                } = await axios.get(`${this.SERVER_URL}fetchEebsStructures`);
